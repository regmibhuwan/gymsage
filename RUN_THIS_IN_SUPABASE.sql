-- ====================================================================
-- GYMSAGE VISUAL PROGRESS TRACKER - DATABASE MIGRATION
-- Run this in your Supabase SQL Editor
-- ====================================================================

-- Step 1: Add new columns to photos table
ALTER TABLE photos
...
-- Step 5: Migrate existing photos (if any)
UPDATE photos
...
-- ====================================================================
-- Now you can:
-- 1. Upload photos with muscle group selection
-- 2. Get AI analysis and comparisons
-- 3. View timelines and trends
-- 4. Ask AI Coach muscle-specific questions
-- ====================================================================
